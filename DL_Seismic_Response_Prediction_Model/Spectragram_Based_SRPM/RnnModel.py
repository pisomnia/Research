...
from keras.layers import Dense, LSTM, Conv1D, GRU, Activation, Dropout, BatchNormalization
...
class RnnModel(object):
    ...
    def createModel(self):
        ...
        GM_input = Input(shape=self.gm_shape)
        BR_input = Input(shape=self.br_shape)
        GM_features = GM_input
...
#     rnn_model = RnnModel(2, 2, 4, (14, 36), (14, 2), (32, 16), (32, 64), (128, 64, 32, 10), 0.2)
