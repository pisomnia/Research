...
%% Constants
MAX_FREQ = 12; % Max frequency of the matrix
NORMALIZE = false; % Do normalize windows or not
% WINDOW_TIME = 5; % Time of each window
% WINDOW_TIME_MOVEMENT = 2.5; % Movement of the windows
 WINDOW_TIME = 3; % Time of each window
 WINDOW_TIME_MOVEMENT = 2; % Movement of the windows
